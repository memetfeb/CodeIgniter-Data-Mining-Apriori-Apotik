...
<head>
  ...
  <!-- <link rel="icon" href="<?php echo base_url('images/'.$sekolah->logo_sekolah) ?>" type="image/ico" /> -->
...
<body class="login" style="background-image: url('images/bg-login.jpg'); background-repeat: no-repeat; background-attachment: fixed; background-size: cover;">
  <div>
    ...
    <div class="login_wrapper">
      <div class="animate form login_form">
        <section class="login_content">
          <img src="images/default.png" height="150" width="150"  /> 
